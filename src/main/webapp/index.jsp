  ...
  <body>
    ...
    <div class="container-narrow">
      ...
      <div class="jumbotron">
        ...
        <p class="lead">The application will assist you in finding the right job near to your location and matching your skills. No need to relocate to a new place.</p>
        <a class="btn btn-large btn-success" href="signup">Sign up today</a><br/><br>
        <p clas="lead">Or</p>
        <!-- LINKEDIN SIGNIN -->
		<form name="li_signin" id="li_signin" action="<c:url value="/signin/linkedin"/>" method="POST">
			<button class="btn btn-large btn-success" type="submit">Sign In with LinkedIn</button>
		</form>
      </div>
      ...
      <div class="row-fluid marketing">
        ...
        <div class="span6">
          ...
          <p>Jobs on latest technologies like MongoDB, OpenShift, Scala, Clojure, NoSQL,etc.</p>
